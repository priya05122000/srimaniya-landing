...
const ScholarForm: React.FC = () => {
  ...
  return (
    <div className="min-h-[100vh-80px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1.5fr]">
      {/* Form Section */}
      <div className="flex items-center justify-center bg-blue-custom p-4 md:p-8">
        <div className="w-full max-w-xl">
          ...
          <form className="flex flex-col gap-y-3" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end mt-4">
              ...
              >
                <span className="relative z-20 text-center w-full px-2 py-1 text-[#FFCE54] text-base transition-all duration-300 group-hover:text-[#0B2351]">
                  Submit
                </span>
